...
fn all_queries() -> Vec<QueryInfo> {
    vec![
        ...
        QueryInfo { name: "DISCOVER_CLIP_COLUMNS", description: "Show columns of maker Clipper_evt_Take", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_TRY_CLIP", description: "SELECT * FROM maker Clipper_evt_Take LIMIT 1", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_TRY_GMX", description: "Find GMX schemas on Arbitrum", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_TRY_GAINS", description: "Find Gains schemas on Arbitrum", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_TRY_SYNX", description: "Find Synthetix schemas on Ethereum", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_MAKER_TABLES", description: "Find MakerDAO tables", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_ALL_MAKER", description: "SHOW TABLES FROM maker_ethereum", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_ALL_GMX_ARB", description: "SHOW TABLES FROM gmx_arbitrum", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_ALL_GMX_ROUTER_ARB", description: "SHOW TABLES FROM gmx_router_arbitrum", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_ALL_GAINS_ARB", description: "SHOW TABLES FROM gains_network_arbitrum", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_ALL_SYNX_ETH", description: "SHOW TABLES FROM synthetix_ethereum", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_ALL_CURVE_POLY", description: "SHOW TABLES FROM curve_polygon", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_ALL_UNIV2_POLY", description: "SHOW SCHEMAS LIKE uniswap v2 polygon", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_MAKER_FLIP", description: "SHOW TABLES FROM maker_ethereum LIKE Vow", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_MAKER_CLIPPER", description: "SHOW TABLES FROM maker_ethereum LIKE Clip", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GMX_ARB_SHOW", description: "SHOW SCHEMAS LIKE gmx arbitrum", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GMX_V2_ARB_SHOW", description: "SHOW SCHEMAS LIKE gmx_router arbitrum", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GAINS_ARB_SHOW", description: "SHOW SCHEMAS LIKE gains arbitrum", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_SYNX_ETH_SHOW", description: "SHOW SCHEMAS LIKE synthetix ethereum", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_CURVE_POLY_SHOW", description: "SHOW SCHEMAS LIKE curve polygon", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GMX_LIQ_TABLES", description: "SHOW TABLES FROM gmx_arbitrum LIKE Liquidat", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GAINS_LIQ_TABLES", description: "SHOW TABLES FROM gains_network_arbitrum LIKE Liquidat", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_SYNX_LIQ_TABLES", description: "SHOW TABLES FROM synthetix_ethereum LIKE Liquidat", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_SYNX_V3_LIQ_TABLES", description: "SHOW TABLES FROM synthetix_v3_ethereum LIKE Liquidat", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_MAKER_VOW_FLIP", description: "SHOW TABLES FROM maker_ethereum LIKE Flip", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_MAKER_CLIPPER_TAKE", description: "SHOW TABLES FROM maker_ethereum LIKE Take", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GMX_V2_TABLES", description: "SHOW TABLES FROM gmx_v2_arbitrum LIKE Order", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GMX_V21_TABLES", description: "SHOW TABLES FROM gmx_v21_arbitrum LIKE Order", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_MAKER_FULL", description: "Find MakerDAO evt tables with art column", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_MAKER_V2_FULL", description: "Find MakerDAO evt tables with usr column", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GMX_VAULT_FULL", description: "Find GMX tables with feeAmount column", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GMX_V2_ORDER_FULL", description: "Find GMX v2 evt tables", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GAINS_LIQ_FULL", description: "Find Gains arb evt tables", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_SYNX_LIQ_FULL", description: "Find Synthetix eth liquidation tables", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_CURVE_TOKEN_EXCHANGE", description: "Find Curve polygon TokenExchange tables", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_UNIV2_SYNC", description: "Find UniV2 polygon Sync tables", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_MAKER_EVT_TABLES", description: "Find MakerDAO evt tables via information_schema", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GMX_VAULT_EVT", description: "Find GMX arbitrum evt tables", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GMX_V2_EVT", description: "Find GMX v2 arbitrum evt tables", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GMX_V21_EVT", description: "Find GMX v21 arbitrum evt tables", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GAINS_EVT", description: "Find Gains network arbitrum evt tables", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_SYNX_EVT", description: "Find Synthetix ethereum evt tables", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_SYNX_V3_EVT", description: "Find Synthetix v3 ethereum evt tables", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_CURVEFI_POLY_TABLES", description: "SHOW TABLES FROM curvefi_polygon", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_CURVEFI_POLY_LIKE", description: "SHOW TABLES FROM curvefi_polygon LIKE TokenExchange", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_MAKERDAO_SCHEMA_SHOW", description: "SHOW SCHEMAS LIKE maker ethereum", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GMX_LIQ_IN_V2", description: "SHOW TABLES FROM gmx_v2_arbitrum LIKE Liquidat", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GMX_ORDER_IN_V2", description: "SHOW TABLES FROM gmx_v2_arbitrum LIKE Order", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GMX_ADLP_IN_V2", description: "SHOW TABLES FROM gmx_v2_arbitrum LIKE Adl", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GMX_ADLP_IN_V2_UPPER", description: "SHOW TABLES FROM gmx_v2_arbitrum LIKE ADL", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GAINS_ARB_TABLES", description: "SHOW TABLES FROM gains_network_arbitrum LIKE Liquidat", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GAINS_GTOKEN", description: "SHOW TABLES FROM gains_network_arbitrum LIKE GToken", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GAINS_DUIF", description: "SHOW TABLES FROM gains_network_arbitrum LIKE duif", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GAINS_DN", description: "SHOW TABLES FROM gains_network_arbitrum LIKE dncdnc", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_SYNX_V3_COLS", description: "SELECT * FROM synthetix_v3.core_evt_liquidation LIMIT 5", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GMX_V1_VAULT_LIQ", description: "SELECT * FROM gmx_arbitrum.Vault_evt_Liquidation LIMIT 5", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GMX_V2_LIQ_HANDLER", description: "SELECT * FROM gmx_v2_arbitrum.liquidationhandler_evt_oracleerror LIMIT 5", required: &[], optional: &[] },
        QueryInfo { name: "DISCOVER_GMX_V2_ADL_HANDLER", description: "SELECT * FROM gmx_v2_arbitrum.adlhandler_evt_oracleerror LIMIT 5", required: &[], optional: &[] },
    ]
}
