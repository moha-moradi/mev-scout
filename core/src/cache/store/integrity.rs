...
impl super::SqliteStore {
    pub fn find_uncached_blocks(
        ...
        let param_refs: Vec<&dyn rusqlite::types::ToSql> = params
            ...
            .collect();
        // Row errors must propagate (schema drift/DB corruption), not be
        // silently counted as missing blocks — that would report healthy
        // cache as gap and trigger pointless refetches.
